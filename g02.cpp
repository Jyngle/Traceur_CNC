...
G02::G02(float _X, float _Y, float _I, float _J, float _F){
...
QString G02::gcode_ligne(){
    ...
    return "G02 X " + QString::number(X_abs) + " Y " + QString::number(Y_abs) + " I " + QString::number(I) + " J " + QString::number(J) + " F " + QString::number(F);
