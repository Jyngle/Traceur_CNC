...
G03::G03(long double _X, long double _Y, long double _Z, long double _I, long double _J, long double _F){
...
QString G03::gcode_ligne(){
    ...
    return "G03 X " + QString::number((float)X_abs) + " Y "  + QString::number((float)Y_abs) + " Z "  + QString::number((float)Z_abs) + " I " + QString::number((float)((abs(I)<0.00001)?0:I)) + " J " + QString::number((float)((abs(J)<0.00001)?0:J)) + " F " + QString::number(F);
